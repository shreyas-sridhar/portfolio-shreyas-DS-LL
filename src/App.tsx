                ...
                <Node index={5} id="contact" isLast={true}>
                    <SectionContent title="Contact">
                        ...
                        <div className="flex flex-col space-y-4">
                            ...
                            <a href="https://drive.google.com/file/d/1n4fe7eAQY9w6ytwi_wNShxpAIyecbveM/view?usp=sharing" className="flex items-center space-x-3 text-accent hover:text-white transition-colors" target="_blank" rel="noreferrer">
